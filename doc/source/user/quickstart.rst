...
`Development Environment with Vagrant <https://docs.openstack.org/kolla-ansible/ocata/contributor/vagrant-dev-env.html>`_.
...
/path/to/kolla-ansible/ansible/inventory. Copy the configuration files to the
current directory.
